...
export default function FavVacationModal({ userID, onSave }: { userID: string, onSave: (vacation: IVacation) => void }) {
    ...
    return (
        <main className="flex flex-col justify-evenly items-center space-y-12">
            <Fieldset legend="Favorite Vacation" className="space-y-5">
